...
import { Activity, Building2, Mail, Phone, UserRound, UsersRound } from 'lucide-react'
...
export function ContactsPage() {
  ...
  return (
    <AppLayout>
      <PageShell
        title="Contacts"
        description="Review customer contacts and communication details."
      >
        <motion.section
        ...
        <SearchPanel
          ...
          placeholder="Search contacts by name, email, phone, position, or customer"
        />
              ...
              <tbody className="divide-y divide-[var(--crm-border)]">
                ...
                {!loading && visibleContacts.length === 0 && (
                  <EmptyState
                    ...
                    message="Try another name, email, phone number, position, or customer."
                    colSpan={6}
                  />
                )}
              </tbody>
